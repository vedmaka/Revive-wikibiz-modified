...
$oTpl->assign('canACL', 1);
$oTpl->assign('canEdit', 1 || OA_Permission::hasPermission(OA_PERM_BANNER_EDIT));
$oTpl->assign('canActivate', 1 || OA_Permission::hasPermission(OA_PERM_BANNER_ACTIVATE));
$oTpl->assign('canDeactivate', 1 || OA_Permission::hasPermission(OA_PERM_BANNER_DEACTIVATE));
$oTpl->assign('canDelete', 1);
//////////////////*end OpenXmods *///////////////////////////////////////////
