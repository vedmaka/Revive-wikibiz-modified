...
class OA_Admin_Option
{
    ...
    function getSettingsPreferences($section)
    {
		...
		///////////////////////////* Begin OpenXmods *//////////////////////////////////
		'paypal'          => array('name' => "PayPal Settings",       			'perm' => OA_ACCOUNT_ADMIN),
                'signup' 	  => array('name' => "Sign Up Settings",     			'perm' => OA_ACCOUNT_ADMIN),
                'authorize' 	  => array('name' => "Authorize.net Settings",                  'perm' => OA_ACCOUNT_ADMIN),
		///////////////////////////* end OpenXmods *////////////////////////////////////
            );
        }
